...
<body>
    ...
    <div class="container">
        ...
        <div class="row row-cols-1 row-cols-sm-3 row-cols-md-3 g-3">
                <?php
                    $cases = array(
                        'case1' => array('Denuncian al informático que encontró una brecha de datos en la app de metro de Valencia', "Ferrocarrils de la Generalitat Valenciana (FGV) denunció al ingeniero informático que encontró una vulnerabilidad en la aplicación de Metrovalencia y TRAM.", 'pages/noticias/noticia1.php', 'img/news/1.jpg'),
