...
<body>
    ...
    <div class="container">
        ...
        <div class="row row-cols-1 row-cols-sm-3 row-cols-md-3 g-3">
                <?php
                    $cases = array(
                        'case1' => array('Caso 1', 'El caso mas importante de la carrera politica de barcenas', 'pages/noticias/noticia1.php', 'img/news/1.jpg'),
                        'case2' => array('Caso 2', 'asdfasdfadsf', 'pages/noticias/noticia2.php', 'img/news/2.jpg'),
